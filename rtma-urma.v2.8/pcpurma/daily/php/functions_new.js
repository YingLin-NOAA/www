...
function getURL(domain,variable,frame,level,season){
...
function preload(obj){
	...
	for (i2=0; i2<hrs_loop.length; i2++){
		...
		var urls = getURL(obj.domain,obj.variable,i,obj.level,obj.season);
...
function updateMobile(){
	...
	|| navigator.userAgent.match(/Windows Phone/i)
		...
		document.getElementById('page-middle').innerHTML = "Swipe Left/Right on Image = Change level | Swipe Up/Down on Image = Change statistic";
	}

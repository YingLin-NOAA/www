...
<div class="page-middle" id="page-middle">
     ...
     <div id="forecastText"> Comparison of 24h totals:<br></div>
<div id="slider">
...
<!-- Image -->
<div id="page-map">
<table id="tbl-map" style='width:950px;margin-left:10px;'>
     <tbody>
       <tr>
         <td id ="td-map">
           <img src="/users/verification/precip/rtma-urma.v2.8/pcpurma/daily/pcpurma.latest_a24h.png" style="width:100%">
        </td>
        <td id="td-stage-map">
           <img src="/users/verification/precip/rtma-urma.v2.8/pcpurma/daily/pcpurma2p8.latest_a24h.png" style="width:100%">
        </td>
      </tr>
    </tbody>
</table>

...
<!-- Head element -->
<div class="page-top">
	<span><a style="color:#ffffff">NCEP/EMC PRECIPITATION VERIFICATION</a></span>
</div>
...
<br>
   Precipitation verification for model forecast includes quantitative verification against precipitation analyses (QPF verification scores, mainly ConUS), daily side-by-side forecast <i>vs.</i> analysis comparisons (ConUS and OConUS),  
<P>
   This page also includes validation of analyses (precipitation RTMA and URMA) against QC'd daily gauge reports.  
<p>
Types of scores (under construction)<br>
<UL>
   <LI><a href="https://www.emc.ncep.noaa.gov/mmb/ylin/pcpverif/scores/docs/ets_bias.gif">ETS/bias</a>
   <LI><a href="https://www.emc.ncep.noaa.gov/mmb/ylin/pcpverif/scores/docs/QandA.html#SCORETYPES">Other scores that can be computed from contingency table stats</a>
   <LI><a href="https://www.emc.ncep.noaa.gov/mmb/ylin/pcpverif/scores/docs/fss.gif">FSS</a>
</LI>
</UL>
<P>
Please use the links on the left to navigate to various components of precipitation verification</a> 
<br>
</div>
</body>

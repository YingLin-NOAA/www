...
function generate_url(){
	...
	//Add season
	append += "season=" + imageObj.season;
	
	//Add variable
	append += "&variable=" + imageObj.variable;

        //Add variable
        append += "&level=" + imageObj.level;
...
function updateMobile(){
	...
	|| navigator.userAgent.match(/Windows Phone/i)
		...
		document.getElementById('page-middle').innerHTML = "Swipe Left/Right on Image = Change forecast lead | Swipe Up/Down on Image = Change precip. threshold";
	}
